...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./packages/notice/notive.vue?vue&type=template&id=0d7afc3a&scoped=true&
var render = function render(){var _vm=this,_c=_vm._self._c;return _c('div',{style:({
    height: _vm.computedHeight,
    overflow: 'hidden',
    '--upPx': _vm.upPx,
  })},[_c('div',{style:({
      height: `${_vm.childHeight}px`,
      'line-height': `${_vm.childHeight}px`,
